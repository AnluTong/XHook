...
public class ClassPool {
        ...
        try {
            AccessController.doPrivileged(new PrivilegedExceptionAction() {
                public Object run() throws Exception {
                    ...
                    definePackage = cl.getDeclaredMethod("definePackage", new Class[] { String.class, String.class, String.class, String.class, String.class, String.class, String.class,
                            URL.class });
                    return null;
                }
            });
    ...
    public static synchronized ClassPool getDefault(Context ctx) {
        if (defaultPool == null) {
            defaultPool = new ClassPool(null);
            defaultPool.appendSystemPath(ctx);
        }
     ...
     *
     * @param name
     *            the name of <code>$cflow</code> variable
     */
    ...
    public ClassPath appendSystemPath(Context ctx) {
        return source.appendSystemPath(ctx);
    }
     ...
     *             overriding this method should be modified. It should override {@link #toClass(CtClass,ClassLoader,ProtectionDomain)}.
     */
     ...
     *
     * @param loader
     *            the class loader passed to <code>toClass()</code> or
